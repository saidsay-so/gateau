...
and curl will import those which match the requested domains and use them for the request.
...
In this example, gateau will output cookies from Chrome in Netscape format,
and wget will import those which match the requested domains and use them for the request.
